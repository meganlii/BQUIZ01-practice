...
// 步驟1：新增功能/彈出視窗
1. 複製/修改 .\modal\admin.php 更名為 .\modal\menu.php
2. 題目沒有給彈出視窗圖例，沿用之前即可 一時之間忘記新增功能是  新增欄位
3. <h3>更名 新增主選單
4. 刪除 <label>確認密碼
5. 09行 13行 對照.\backend\menu.php表格欄位標題  
更名為主選單名稱 選單連結網址
10行 13行 type="password" name="pw" 改成 type="text" name="href"

// 步驟2
測試新增功能 顯示功能沒有預設打勾 回到.\backend\menu.php 
38行 加上php變數< ?=($row['sh'] == 1) ? "checked" : "" ;?>

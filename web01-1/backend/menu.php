    ...
    <table width="100%">
      <tbody>
        ...
        */
        ...
        /*
        $rows = [
            0 => ['id'=>1, 'text'=>'選單1', 'main_id'=>0, 'href'=>'page1.php'],
            1 => ['id'=>2, 'text'=>'選單2', 'main_id'=>0, 'href'=>'page2.php'], 
            2 => ['id'=>3, 'text'=>'選單3', 'main_id'=>0, 'href'=>'page3.php']
        ];

        1. 「把每一筆資料逐一取出，每次取一筆叫做 $row」
        第1次迴圈：
        $row = ['id'=>1, 'text'=>'選單1', 'main_id'=>0, 'href'=>'page1.php']

        第2次迴圈：
        $row = ['id'=>2, 'text'=>'選單2', 'main_id'=>0, 'href'=>'page2.php']

        第3次迴圈：
        $row = ['id'=>3, 'text'=>'選單3', 'main_id'=>0, 'href'=>'page3.php']

        2. foreach = 可以產生任何資料型態
        之前的誤解：foreach = 只會產生單一值 (字串/數字)
        - 字串 → 直接使用
        - 數字 → 直接使用  
        - 陣列 → 需要指定元素
        - 物件 → 需要存取屬性
